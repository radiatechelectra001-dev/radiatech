        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
            {companyInfo.clientLogos.map((client) => (
              <div key={client.name} className="bg-white rounded-xl p-8 flex flex-col items-center justify-center gap-3 shadow-sm hover:shadow-lg transition-all border border-gray-100 hover:border-primary/20">
