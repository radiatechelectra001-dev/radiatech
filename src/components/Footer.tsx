        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="mt-4 sm:mt-5 flex flex-wrap gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center bg-accent hover:bg-accent-dark text-white px-5 sm:px-6 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-semibold transition-colors"
              >
                Send Inquiry
              </Link>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-white/20 px-5 sm:px-6 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-semibold text-white hover:bg-white/10 transition-colors"
              >
